import"./bootstrap-DIuewKhF.js";import{$ as a}from"./dataTables-DiaTurq6.js";a(function(){a.getJSON("/anggota/golongan-pramuka",function(e){e.forEach(function(t){a("#filterMapel").append(`<option value="${t}">${t}</option>`)})});const l=a("#guruTable").DataTable({processing:"",scrollX:!1,searching:!0,serverSide:!0,ajax:{url:"/data-anggota",data:function(e){e.golongan_pramuka=a("#filterMapel").val()},dataSrc:function(e){return a("#anggotaLoading").hide(),a("#guruTable").removeClass("hidden"),!e.data||e.data.length===0?(a("#guruTable tbody").html('<tr><td colspan="10" class="text-center py-4 text-gray-500">Tidak ada data ditemukan</td></tr>'),[]):e.data},beforeSend:function(){a("#anggotaLoading").show(),a("#guruTable").addClass("hidden")},error:function(){a("#anggotaLoading").hide(),alert("Gagal memuat data anggota. Coba lagi nanti.")}},preDrawCallback:function(){a(".dataTables_processing").hide()},columns:[{data:"nomor_anggota",name:"anggotas.nomor_anggota",orderable:!1,render:e=>`<div class="font-mono text-sm text-gray-600">${String(e)||"-"}</div>`},{data:"nama",name:"nama",orderable:!1,render:e=>`<div class="font-medium text-gray-900">${e}</div>`},{data:"nik",name:"nik",orderable:!1,render:e=>`<span class="text-gray-700">${e||"-"}</span>`},{data:"jenis_kelamin",name:"jenis_kelamin",orderable:!1,render:e=>`<span class="text-gray-700">${e||"-"}</span>`},{data:"golongan_pramuka",name:"golongan_pramuka",orderable:!1,render:e=>`<span class="px-2 py-1 text-xs bg-red-500 text-white rounded whitespace-nowrap">${e||"-"}</span>`},{data:"golongan_darah",name:"golongan_darah",orderable:!1,render:e=>`<span class="px-2 py-1 text-xs bg-red-100 text-red-600 rounded">${e||"-"}</span>`},{data:null,name:"anggotas.tempat_lahir",orderable:!1,render:(e,t,n)=>{const o=n.tempat_lahir||"-",r=n.tanggal_lahir||"-";return`<div class="text-gray-700 whitespace-nowrap">${o}, ${r}</div>`}},{data:"no_telp",name:"no_telp",orderable:!1,render:e=>`<span class="font-mono text-sm whitespace-nowrap">${e||"-"}</span>`},{data:"nomor_anggota",name:"kta",orderable:!1,searchable:!1,render:e=>`
                ...
                `},{data:"sertifikat_link",name:"sertifikat_link",orderable:!1,searchable:!1,render:e=>e?`
                        <div class="flex flex-col gap-1">
                            <span class="font-mono text-[10px] font-bold text-gray-700">${e.nomor}</span>
                            <div class="flex gap-1">
                                <a href="${e.url_show}" target="_blank"
                                class="px-2 py-0.5 bg-blue-50 text-blue-600 border border-blue-200 rounded text-[10px] hover:bg-blue-100 transition">
                                Lihat
                                </a>
                                <a href="${e.url_download}"
                                class="px-2 py-0.5 bg-green-50 text-green-600 border border-green-200 rounded text-[10px] hover:bg-green-100 transition">
                                Unduh
                                </a>
                            </div>
                        </div>
                    `:'<span class="text-gray-400 text-xs italic">Belum ada</span>'},{data:"nomor_anggota",name:"aksi",orderable:!1,searchable:!1,render:e=>`
                ...
                `}],lengthChange:!1,pageLength:10,dom:'rt<"flex mt-4 justify-center"p>',language:{processing:"",paginate:{previous:'<span class="px-3 py-1 rounded-lg bg-gray-100 hover:bg-[#610a08] hover:text-white transition">Prev</span>',next:'<span class="px-3 py-1 rounded-lg bg-gray-100 hover:bg-[#610a08] hover:text-white transition">Next</span>'}},drawCallback:function(){a(".action-btn").off("click").on("click",function(t){t.stopPropagation();const n=a(this),o=n.siblings(".dropdown-menu"),r=n[0].getBoundingClientRect();if(a("#floating-dropdown").remove(),o.data("open")){o.data("open",!1);return}const s=o.clone();s.attr("id","floating-dropdown").removeClass("hidden").css({position:"fixed",top:r.bottom+5+"px",left:r.right-140+"px",zIndex:9999}).appendTo("body"),o.data("open",!0),s.find(".delete-form").on("submit",function(i){i.preventDefault(),confirm("Yakin ingin menghapus anggota ini?")&&this.submit()})}),a(document).off("click.dropdown").on("click.dropdown",function(){a("#floating-dropdown").remove(),a(".action-btn").each(function(){a(this).siblings(".dropdown-menu").data("open",!1)})}),a(document).off("click.dropdown").on("click.dropdown",function(){a(".dropdown-menu").addClass("hidden")}),a(".delete-form").off("submit").on("submit",function(t){t.preventDefault(),confirm("Yakin ingin menghapus anggota ini?")&&this.submit()}),a("#guruTable thead th").each(function(){let t=a(this).find(".dt-sort-icon");t.length!==0&&(t.html(""),a(this).hasClass("sorting_asc")?t.html('<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-700" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 3l5 7H5l5-7z" clip-rule="evenodd" /></svg>'):a(this).hasClass("sorting_desc")?t.html('<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-700" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 17l-5-7h10l-5 7z" clip-rule="evenodd" /></svg>'):t.html('<svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4" /></svg>'))});const e=a(".custom-datatable-wrapper")[0];if(e){const t=()=>{const n=e.scrollLeft>=e.scrollWidth-e.clientWidth-5;a(e).toggleClass("scrolled-end",n)};a(e).off("scroll.check").on("scroll.check",t),t()}}});a("#searchGuru").on("keyup",function(){l.search(this.value).draw()}),a("#filterMapel").on("change",function(){l.ajax.reload()})});
