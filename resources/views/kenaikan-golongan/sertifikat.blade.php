...
<div class="body">
  ...
  <div class="col-r">
    ...
    <table class="dtbl">
      <tr><td class="lbl">Tempat / Tgl. Lahir</td><td class="sep">:</td><td>{{ $kenaikan->anggota->tempat_lahir }}, {{ \Carbon\Carbon::parse($kenaikan->anggota->tanggal_lahir)->translatedFormat("d F Y") }}</td></tr>
    ...
    <div class="para">
      ...
      pada hari, tanggal <span class="hl">{{ \Carbon\Carbon::parse($kenaikan->tanggal_kenaikan)->translatedFormat("l, d F Y") }}</span>
...
<div class="ftr">
  ...
  <div class="ttd">
    ...
    <div class="ttd-issued">Pada Tanggal: <strong>{{ \Carbon\Carbon::parse($kenaikan->tanggal_kenaikan)->translatedFormat("d F Y") }}</strong></div>
