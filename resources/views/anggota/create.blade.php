<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mt-4 mx-auto px-4 sm:px-6 lg:px-8">
            <form action="{{ route('anggota.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white shadow-md sm:rounded-lg p-6">
                        ...
                        <h2 class="text-base font-bold text-gray-700 mb-4 pb-2 border-b border-gray-200">Data Pribadi</h2>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                            ...
                            <!-- Jenis Kelamin -->
                            <div x-data="{ open: false, selected: '{{ old('jenis_kelamin') }}', options: ['Laki-laki', 'Perempuan'] }">
                            ...
                            <!-- Agama -->
                            <div x-data="{ open: false, selected: '{{ old('agama') }}', options: ['Islam', 'Kristen', 'Katolik', 'Hindu', 'Buddha', 'Konghucu'] }">
                            ...
                            <!-- Golongan Darah -->
                            <div x-data="{ open: false, selected: '{{ old('golongan_darah') }}', options: ['A', 'B', 'AB', 'O'] }">
                    ...
                    {{-- Card 2: Kepramukaan --}}
                    <div class="bg-white shadow-md sm:rounded-lg p-6 flex flex-col">

                        <h2 class="text-base font-bold text-gray-700 mb-4 pb-2 border-b border-gray-200">Kepramukaan</h2>

                        <div x-data="{
                            openGol: false,
                            openTingkat: false,
                            golongan: '{{ old('golongan_pramuka') }}',
                            tingkat: '{{ old('tingkat_pramuka') }}',
                            golonganOptions: {
                            ...
                            <div>
                                ...
                                @error('golongan_pramuka')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <button type="button" @click="if(tingkatOptions.length) openTingkat = !openTingkat"
                                        :class="tingkatOptions.length ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'"
                                        ...
                                        <span
                                            x-text="tingkat || (golongan && !tingkatOptions.length ? 'Tidak ada tingkatan' : '-- Pilih Tingkat --')"
                                            :class="!tingkat ? 'text-gray-400' : 'text-gray-600'">
                                        </span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                        </svg>
                        ...
                        {{-- Tombol Aksi — pushed to bottom on desktop --}}
                        <div class="mt-auto pt-4 border-t border-gray-200 flex items-center justify-end gap-3">
                            <a href="{{ route('anggota') }}"
                               class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800 transition">
                                Batal
                            </a>
                            <x-primary-button type="submit">Simpan Anggota</x-primary-button>
                        </div>
